...
<section class="section section--close wrap center">
  <div class="measure" data-reveal>
    <h2 class="h2">Et avec un groupe, encadré par Esope, avec des objectifs concrets, c'est
      encore mieux !</h2>
    <p class="lead mute" style="margin-top:24px">Ce genre d'exercice prend tout son sens à
      plusieurs, avec le rire, l'émulation et l'enjeu d'un projet.</p>

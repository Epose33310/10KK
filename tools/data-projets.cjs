/**
 * Les récits du carnet « Les derniers projets ».
 *
 * Fichier de données pur, sans écriture disque : build-projets.cjs s'en sert
 * pour générer les pages, build-pages.cjs y pioche des liens vers les récits
 * d'un atelier donné (voir la section qui suit la FAQ de chaque page).
 *
 * Champs d'un article — voir aussi le commentaire en tête de build-projets.cjs :
 *   ...
 *   atelier   slam | rap | eloquence | battle  (donne la couleur de la carte)
 *   tags      un ou plusieurs parmi slam | rap | eloquence | battle — sert au
...
},
{
  ...
  tags: ['eloquence'],
  secteur: ['education'],
  h1: 'Un concours d’éloquence en ligne de mire, au lycée Bertran de Born',
  seo: 'Atelier éloquence au lycée — Bertran de Born, Périgueux',
  meta: "Six heures d'atelier d'éloquence d'un coup, avec une classe du lycée Bertran de Born à Périgueux : de l'initiation à la déclamation, avant un concours d'éloquence et le bac.",
  chapo: "Au lycée Bertran de Born, à Périgueux, une classe s'est lancée dans six heures d'atelier éloquence d'un seul coup, de l'initiation jusqu'à la déclamation — un projet pensé pour un concours d'éloquence et pour le bac.",
  lieu: 'Lycée Bertran de Born, Périgueux (Dordogne)',
  publics: 'Une classe de lycée',
  format: "6 h d'atelier en une seule fois",
  motCle: 'atelier éloquence lycée Périgueux',
  secondes: ['atelier éloquence concours', 'initiation éloquence déclamation'],
  images: {
    principale: { src: 'declamation-concours-eloquence-lycee.jpg',
      alt: 'Illustration au trait d’un lycéen de dos, seul face au micro sous un projecteur',
      legende: 'La déclamation, point d’arrivée des six heures d’atelier.' },
    deux: { src: 'atelier-eloquence-classe-lycee-perigueux.jpg',
      alt: 'Illustration au trait d’un intervenant devant une classe de lycée, rangées de tables face à lui' },
    trois: { src: 'lyceenne-ecrit-son-texte-eloquence.jpg',
      alt: 'Illustration au trait d’une lycéenne penchée sur son cahier, en train d’écrire' },
  },
  corps: [
    ['p', `Le lycée <b>Bertran de Born</b>, à <b>Périgueux</b>, a misé sur un format concentré pour son atelier d'<b>éloquence</b> : six heures d'un coup, avec une seule classe, de l'initiation jusqu'à la déclamation. Un projet pensé pour préparer un concours d'éloquence — et, plus largement, les épreuves orales du bac.`],
    ['h2', 'Le contexte : un projet calé sur deux échéances réelles'],
    ['p', `Une classe qui prépare à la fois un concours d'éloquence et le bac n'a pas besoin qu'on lui explique pourquoi bien parler compte : l'enjeu est déjà là, concret, daté. Mon rôle a consisté à construire, en six heures, un parcours complet — de la découverte du format à un premier passage abouti — plutôt qu'une simple initiation qui resterait sans suite.`],
    ['h2', 'Le déroulement de la journée'],
    ['p', `Six heures d'un coup, c'est un format qui ne laisse pas de place à l'attente : on entre dans le vif du sujet dès les premières minutes. La matinée a été consacrée à poser les bases — placement de voix, regard, gestion du trac — avant de passer à la construction d'un propos et à son écriture. L'après-midi a basculé vers la mise en voix et les premiers passages, jusqu'à un temps de déclamation individuelle en fin de journée.`],
    ['img', 'deux'],
    ['h2', 'Les techniques travaillées'],
    ...
    ['p', `Cette journée a permis de travailler la prise de parole dans des conditions proches de celles d'un oral d'examen : peu de temps de préparation, un passage individuel, un jury attentif. Pour une classe qui vise à la fois un concours et le bac, cette proximité avec les conditions réelles compte au moins autant que le contenu technique.`],
    ['img', 'trois'],
    ['h2', 'Le moment marquant'],
    ['p', `La déclamation de fin de journée a fonctionné comme une vraie répétition générale : chacun est passé devant la classe entière, dans les conditions les plus proches possible de ce qui les attend au concours. Voir des élèves qui n'avaient jamais pris la parole en public le matin tenir une déclamation construite l'après-midi même a confirmé qu'un format concentré peut aller très loin en une seule journée.`],
    ['expert', {
      titre: 'Un atelier éloquence en une seule journée, ce que ça implique',
      qr: [
        ["Six heures d'un coup, est-ce trop pour un premier atelier d'éloquence ?",
         `Non, à condition de construire une vraie progression plutôt que d'empiler des exercices. La journée avance par étapes — bases, écriture, mise en voix, déclamation — et chaque élève arrive au bout avec un texte dit, pas seulement des notions vues en passant.`],
        ['Ce format convient-il à une classe qui prépare un concours précis ?',
         `C'est même l'un des formats les plus efficaces pour ça. La déclamation de fin de journée reproduit les conditions du concours — passage individuel, temps limité, jury — ce qui donne à la classe un premier aperçu très concret de ce qui l'attend.`],
      ],
    }],
    ['h2', 'Ce que ce projet a permis d’explorer'],
    ['p', `Cette journée a confirmé qu'un format concentré, loin d'être un pis-aller, peut construire une vraie progression quand chaque étape vise clairement le moment final. Si votre établissement prépare un concours d'éloquence ou une échéance orale précise, <a href="index.html#contact">parlons du format qui conviendrait</a>.`],
  ],
},
{
  slug: 'atelier-slam-cm2-biganos',
  ordre: 240,
  atelier: 'slam',
  tags: ['slam'],
  secteur: ['education'],
  h1: 'Deux journées de slam avec des CM2, à Biganos',
  seo: 'Atelier slam en CM2 — école primaire, Biganos',
  meta: "26 élèves de CM2, deux journées de six heures d'atelier slam à Biganos : une imagination débordante, une envie d'oser qu'on ne retrouve pas toujours chez les plus grands.",
  chapo: "À Biganos, 26 élèves de CM2 ont enchaîné deux journées de six heures d'atelier slam. Très demandeurs, débordants d'imagination : à cet âge, la poésie n'a aucune limite.",
  lieu: 'Biganos (Gironde)',
  publics: '26 élèves de CM2',
  format: 'Deux journées de 6 h',
  motCle: 'atelier slam CM2 Biganos',
  secondes: ['atelier slam école primaire', 'atelier slam Gironde'],
  images: {
    principale: { src: 'atelier-slam-cm2-mains-levees-biganos.jpg',
      alt: 'Illustration au trait d’une classe qui lève la main, intervenant debout devant le tableau',
      legende: 'Vingt-six élèves très demandeurs — la difficulté a été de donner la parole à tout le monde.' },
    deux: { src: 'mains-rythme-atelier-slam-cm2.jpg',
      alt: 'Illustration au trait de deux mains qui comptent un rythme' },
    trois: { src: 'poing-a-poing-cohesion-atelier-slam.jpg',
      alt: 'Illustration au trait de deux poings qui se cognent' },
  },
  corps: [
    ['p', `Vingt-six élèves de <b>CM2</b>, à <b>Biganos</b>, ont enchaîné deux journées de six heures d'atelier <b>slam</b>. Un volume horaire conséquent pour cet âge, et un groupe qui l'a rempli sans jamais faiblir.`],
    ['h2', 'Le contexte : un groupe nombreux, très demandeur'],
    ['p', `Vingt-six élèves sur un atelier d'écriture, c'est un chiffre qui peut inquiéter — la parole individuelle se dilue vite dans un grand groupe. Ici, c'est l'inverse qui s'est produit : le nombre a nourri l'énergie collective plutôt que de la freiner. La difficulté n'a pas été de motiver le groupe, mais de trouver le temps de faire passer tout le monde au micro.`],
    ['h2', 'Le déroulement des deux journées'],
    ['p', `Douze heures au total, réparties sur deux journées complètes, ont permis d'aller au bout d'une vraie progression : jeux oraux, collecte d'images, écriture, réécriture, mise en voix. Avec un groupe aussi nombreux, chaque étape a demandé plus de temps qu'à l'accoutumée pour que chacun ait son tour — mais le rythme n'a jamais faibli.`],
    ['img', 'deux'],
    ['h2', 'Les techniques travaillées'],
    ...
    ['img', 'trois'],
    ['h2', 'Le moment marquant'],
    ['p', `Ce qui frappe avec un groupe de CM2, c'est la vitesse à laquelle une idée devient un texte, puis un passage au micro. Il n'y a pas ce temps de flottement qu'on observe souvent chez des élèves plus âgés, plus soucieux du regard des autres avant d'oser. Vingt-six élèves qui gardent cette énergie sur deux journées entières, sans jamais se lasser, c'est suffisamment rare pour être noté.`],
    ['expert', {
      titre: 'Un atelier slam avec un grand groupe de CM2, ce qu’il faut savoir',
      qr: [
        ['Vingt-six élèves, n’est-ce pas trop pour un atelier d’écriture ?',
         `C'est beaucoup, mais l'âge compense largement le nombre : les CM2 s'autocensurent moins et écrivent plus vite que des élèves plus grands. La vraie contrainte n'est pas l'attention du groupe, c'est le temps de passage au micro — sur douze heures, on trouve la place pour que chacun passe.`],
        ['Le slam fonctionne-t-il aussi bien en primaire qu’au collège ?',
         `Souvent mieux, sur le plan de l'image et de l'imagination : à cet âge, il n'y a pas encore cette retenue qui s'installe plus tard. Ce qui change, c'est le rythme d'encadrement — un grand groupe de CM2 demande plus de temps individuel qu'une classe de collège du même effectif.`],
      ],
    }],
    ['h2', 'Ce que ce projet a permis d’explorer'],
    ['p', `Deux journées avec vingt-six CM2 ont confirmé ce que j'observe souvent à cet âge : l'imagination ne connaît pas encore de limite, et c'est elle qui fait tout le travail. Si votre école prépare un projet d'écriture avec un grand groupe, quel que soit l'âge, <a href="index.html#contact">parlons du format qui conviendrait</a>.`],
  ],
},
{
...

{
  ...
  tags: ['slam'],
  secteur: ['sante'],
  h1: 'Quatre ans de slam à la Ferme Merlet (CEID), à Saint-Denis-de-Pile',
  seo: 'Atelier slam à Saint-Denis-de-Pile — Ferme Merlet (CEID) et scène ouverte à L’Accordeur',
...
/* ====================================================================== 2 */
{
  ...
  tags: ['rap'],
  secteur: ['jeunesse'],
  h1: 'Un stage de rap pour le projet OPUS, au Rocher de Palmer, à Cenon',
...
/* ====================================================================== 13 */
{
  ...
  tags: ['slam'],
  secteur: ['education'],
  h1: 'Printemps des poètes à Albi : deux collèges, une scène commune',
  seo: 'Atelier slam à Albi — Printemps des poètes, deux collèges du Tarn',

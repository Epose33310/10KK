...
const pages = [
  ...
  },
  {
    ...
    intro: "Un groupe en hôpital de jour, en IME, en EHPAD ou en foyer d'accueil ne se pilote pas comme une classe : la fatigue, la journée, l'état de chacun peuvent changer le programme d'une heure sur l'autre. Ce que je propose ici suit les mêmes principes que mes autres interventions — l'écriture et l'oralité comme espace d'expression — ajustés à un rythme plus lent, des groupes plus restreints, et un cadre qui ne demande jamais de résultat.",
    ...
    goals: [
      ...
      ['Une équipe présente et associée', "Un référent de l'équipe soignante ou éducative reste dans la salle : le cadre reste le sien, je n'interviens qu'en atelier."],
    ],
    defTitre: 'Votre réalité, je la connais',
    defTexte: "Un participant qui ne veut pas écrire aujourd'hui, un autre qui quitte la salle en cours de séance, un groupe dont la composition change d'une fois sur l'autre : rien de tout cela ne fait échouer un atelier, à condition de l'avoir anticipé. Je ne construis jamais une séance sur l'hypothèse que tout le monde ira jusqu'au bout.",
    concretTexte: "Le format se pense avec l'équipe encadrante en amont : durée de séance plus courte que d'ordinaire, groupe réduit, objectif révisable en cours de parcours. La restitution, quand elle a lieu, reste interne par défaut — devant l'équipe et les proches plutôt que devant un public large.",
    ateliers: {
      slam: "Un espace d'écriture personnelle, au rythme du groupe, sans obligation de résultat ni de passage.",
      ...
      battle: "Le format le plus adapté pour ce secteur : on écrit pour l'autre, on reçoit un compliment, jamais un jugement.",
    },
    faq: [
